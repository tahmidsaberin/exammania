...
export interface Subject { id: string; slug: string; name: string; namebn: string; divisionId?: string | null; level?: AcademicLevel | null; isCommon: boolean; color?: "emerald" | "violet" | "blue" | "rose" | "amber" | null; _count?: { exams: number }; }
