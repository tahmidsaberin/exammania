...
export interface Division { id: string; slug: string; name: string; namebn: string; level: AcademicLevel; color?: "emerald" | "violet" | "blue" | "rose" | "amber" | "teal" | "slate" | "indigo" | "fuchsia" | "lime" | null; _count?: { subjects: number; exams: number }; }
export interface Subject { id: string; slug: string; name: string; namebn: string; divisionId?: string | null; level?: AcademicLevel | null; isCommon: boolean; color?: "emerald" | "violet" | "blue" | "rose" | "amber" | "teal" | "slate" | "indigo" | "fuchsia" | "lime" | null; _count?: { exams: number }; }
